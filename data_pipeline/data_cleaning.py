...
def remove_empty_data(file_name_list, img_list, label_list, img_folder, label_folder) :
    """
...
remove_empty_data(empty_labels, IMG_FILE_LIST, LBL_FILE_LIST, IMAGE_FOLDER, LABEL_FOLDER)
